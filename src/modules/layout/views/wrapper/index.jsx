  ...
  render() {
    return (
      <Layout className={styles.layout}>
        <Sider collapsible collapsed={this.state.collapsed} onCollapse={this.onCollapse} collapsedWidth={0} width={120} zeroWidthTriggerStyle={{ top: 0, opacity: 0.01 }}>
          <div className={styles.logo}>顾家家居</div>
